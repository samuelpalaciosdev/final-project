          ...
          <div className="container d-flex justify-content-md-center align-items-center mb-3">
            <div className="col-md-10">
              <div className="step-num-container d-flex align-items-center">
                ...
                <h5 className="fw-semibold">Agregar Especialista</h5>
              </div>
            </div>
          </div>
          <div className="register-form">
            <div className="container">
              ...
              >
                  ...
                  <div className="col-md-10">
                    ...
                    <input
                      ...
                      {...register("phone", {
                        ...
                        pattern: {
                          value: /^[0-9]{8,12}$/,
                          message: "Minimo 8 caracters numéricos, Maximo 12",
                        },
                      })}
                      // If error, then add invalid-input class
                ...
                <div className="row justify-content-center">
                  <div className="col-md-10">
                    ...
                    <input
                      type="text"
                      name="education"
                      placeholder="Cuéntanos de tu formación académica"
                      {...register("education", {
                        required: {
                          value: true,
                          message: "El campo es requerido",
                      ...
                      // If error, then add invalid-input class
                      className={`form-control ${errors.education && "invalid-input"
                        }`}
                ...
                <div className="row justify-content-center">
                  <div className="col-md-10">
                    ...
                    <input
                      type="text"
                      name="experience"
                      placeholder="Cuéntanos más sobre tu formación profesional"
                      {...register("experience", {
                        required: {
                          value: true,
                          message: "El campo es requerido",
                      ...
                      // If error, then add invalid-input class
                      className={`form-control ${errors.experience && "invalid-input"
                        }`}
                ...
                <div className="row justify-content-center">
                  <div className="col-md-10">
                    <label htmlFor="inputSpecialization1" className="form-label">
                      Especialización
                    </label>
                    <input
                      ...
                      // If error, then add invalid-input class
                      className={`form-control ${errors.specialization1 && "invalid-input"
                        }`}
                      value={store.specialization1}
                      onChange={actions.handleChange}
                      id="inputSpecialization1"
                    />
                ...
                <div className="row justify-content-center">
                  <div className="col-md-10">
                    <label htmlFor="inputSpecialization2" className="form-label">
                      Especialización 2
                    </label>
                    <input
                      type="specialization2"
                      name="specialization2"
                      placeholder="Cuéntanos más sobre tu formación académica"
                      ...
                      // If error, then add invalid-input class
                      className={`form-control ${errors.specialization2 && "invalid-input"
                        }`}
                      value={store.specialization2}
                      onChange={actions.handleChange}
                      id="inputSpecialization2"
                    />
